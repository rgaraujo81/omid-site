...
comparar: {
  ...
  p: 'What you built above, priced at the public on-demand rates of AWS, Azure, Google Cloud for the São Paulo region, converted at today\'s exchange rate.',
  ...
  base: 'Public on-demand list prices, no commitment, São Paulo region. Compute as the equivalent instance (AWS, Azure) or per vCPU and GiB (Google); general-purpose SSD; backup as snapshot or object storage; internet egress at the public tiers. Excludes support, IPs, taxes and commitment discounts. Trademarks belong to their owners.',
